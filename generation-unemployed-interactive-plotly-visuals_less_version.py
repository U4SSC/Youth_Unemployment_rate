...
py.plot(fig, validate=False, filename='worldmap2010', auto_open = True)
...
fig = dict(data=data, layout=layout)
py.plot(fig, validate=False, filename='worldmap2014', auto_open = True)
...
py.plot(fig,filename='scatter2010', auto_open = True)
...
fig = go.Figure(data=data, layout=layout)
py.plot(fig,filename='scatter2014', auto_open = True)
